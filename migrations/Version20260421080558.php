 ...
 */
final class Version20260421080558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, is_pinned BOOLEAN NOT NULL, is_pending BOOLEAN NOT NULL, is_completed BOOLEAN NOT NULL, is_archived BOOLEAN NOT NULL, status VARCHAR(255) NOT NULL, user_id INTEGER NOT NULL, folder_id INTEGER NOT NULL, priorities_id INTEGER NOT NULL, CONSTRAINT FK_527EDB25A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_527EDB25162CB942 FOREIGN KEY (folder_id) REFERENCES folder (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_527EDB25E1F1C329 FOREIGN KEY (priorities_id) REFERENCES priority (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
